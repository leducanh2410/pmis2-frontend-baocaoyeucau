...
import { VeBieuDoDetailResolver, VeBieuDoGroupsResolver, VeBieuDoListResolver } from './vebieudo.resolvers';
...
export const VeBieuDoRouteMatcher: (url: UrlSegment[]) => UrlMatchResult = (url: UrlSegment[]) => {
...
export const VeBieuDoRunGuardsAndResolvers: (from: ActivatedRouteSnapshot, to: ActivatedRouteSnapshot) => boolean = (from: ActivatedRouteSnapshot, to: ActivatedRouteSnapshot) => {
...
export const VeBieuDoRoutes: Route[] = [
  {
    path: '',
  ...
  {
    path: '',
    component: VeBieuDoComponent,
    resolve: {
      group: VeBieuDoGroupsResolver,
    },
    children: [
      {
        component: VeBieuDoListComponent,
        matcher: VeBieuDoRouteMatcher,
        runGuardsAndResolvers: VeBieuDoRunGuardsAndResolvers,
        resolve: {
          object: VeBieuDoListResolver
        },
        children: [
          {
            path: '',
            pathMatch: 'full',
            component: VeBieuDoEmptyDetailsComponent
          },
          {
            path: ':id',
            component: VeBieuDoDetailsComponent,
            runGuardsAndResolvers: 'always',
            resolve: {
              objectDetail: VeBieuDoDetailResolver
            }
          }
        ]
      }
