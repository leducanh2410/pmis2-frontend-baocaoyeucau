...
export class NhomDuLieuListResolver implements Resolve<any>
{
    private user: User;
    /**
     * Constructor
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<any[]> | any {
        ...
        sources.push(this._nhomdulieuService.getNhomDuLieuByAll(this.user.ORGID));
            ...
            .pipe(
                finalize(() => {
                    ...
                    if (!currentRoute.paramMap.get('id')) {
                        // Reset the Api
                        this._nhomdulieuService.resetObject().subscribe();
                    }
                }),
...
export class NhomDuLieuDetailResolver implements Resolve<any>
{
    /**
     * Constructor
     */
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<any> {
        ...
        if (route.paramMap.get('id')) {
            sources.push(this._nhomdulieuService.getObjectById(route.paramMap.get('id')));
        }
