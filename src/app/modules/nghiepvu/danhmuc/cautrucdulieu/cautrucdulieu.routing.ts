...
import { CauTrucDuLieuDetailResolver, CauTrucDuLieuGroupsResolver, CauTrucDuLieuResolver } from './cautrucdulieu.resolvers';
...
export const CauTrucDuLieuRouteMatcher: (url: UrlSegment[]) => UrlMatchResult = (url: UrlSegment[]) => {
...
export const CauTrucDuLieuRunGuardsAndResolvers: (from: ActivatedRouteSnapshot, to: ActivatedRouteSnapshot) => boolean = (from: ActivatedRouteSnapshot, to: ActivatedRouteSnapshot) => {
...
export const CauTrucDuLieuRoutes: Route[] = [
  {
    path: '',
  ...
  {
    path: '',
    component: CauTrucDuLieuComponent,
    resolve: {
      group: CauTrucDuLieuGroupsResolver,
    },
    children: [
      {
        component: CauTrucDuLieuListComponent,
        matcher: CauTrucDuLieuRouteMatcher,
        runGuardsAndResolvers: CauTrucDuLieuRunGuardsAndResolvers,
        resolve: {
          apis: CauTrucDuLieuResolver
        },
        children: [
          {
            path: '',
            pathMatch: 'full',
            component: CauTrucDuLieuEmptyDetailsComponent
          },
          {
            path: ':id',
            component: CauTrucDuLieuDetailsComponent,
            runGuardsAndResolvers: 'always',
            resolve: {
              apiDetail: CauTrucDuLieuDetailResolver
            }
          }
        ]
      }
