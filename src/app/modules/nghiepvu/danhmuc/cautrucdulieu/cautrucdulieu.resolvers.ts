...
export class CauTrucDuLieuGroupsResolver implements Resolve<any>
{
    private user: User;
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<any[]> {
        ...
        return this._cautrucdulieuService.getGroups(this.user.ORGID);
    }
}
...
export class CauTrucDuLieuResolver implements Resolve<any>
{
    private user: User;
    /**
     * Constructor
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<any[]> | any {
        ...
        if (route.paramMap.get('group')) {
            sources.push(this._cautrucdulieuService.getObjectsByFolder(route.paramMap.get('group'), route.paramMap.get('page')));
            sources.push(this._cautrucdulieuService.getGroupById(route.paramMap.get('group')));
            sources.push(this._cautrucdulieuService.getLstNguonDuLieu(this.user.ORGID));
            sources.push(this._cautrucdulieuService.getLstKieuDuLieu());
        }
            ...
            .pipe(
                finalize(() => {
                    ...
                    if (!currentRoute.paramMap.get('id')) {
                        // Reset the Api
                        this._cautrucdulieuService.resetObject().subscribe();
                    }
                }),
...
export class CauTrucDuLieuDetailResolver implements Resolve<any>
{
    /**
     * Constructor
     */
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<any> {
        ...
        if (route.paramMap.get('id')) {
            sources.push(this._cautrucdulieuService.getObjectById(route.paramMap.get('id')));
            sources.push(this._cautrucdulieuService.getObjectDetailById(route.paramMap.get('id')));
        }
